...
import dpapukchiev.v1.cost.AggregateCost;
...
import dpapukchiev.v1.effects.CoinRewardDynamicEffect;
import dpapukchiev.v1.effects.PreferentialTrading;
import dpapukchiev.v1.effects.RawMaterialEffect;
import dpapukchiev.v1.effects.VictoryRewardDynamicEffect;
...
public class Deck {
    ...
    private void addAge1() {
        ...
        allCards.add(new SingleManufacturedGoodCard(1, "Glashutte", ManufacturedGood.GLASS, 3));
        allCards.add(new SingleManufacturedGoodCard(1, "Presse", ManufacturedGood.SCRIPTS, 3));
        allCards.add(new SingleManufacturedGoodCard(1, "Webstuhl", ManufacturedGood.TEXTILE, 3));
        ...
        // SCIENCE
        allCards.add(new ScienceCard(1, "Aphoteke", 3, List.of(ScienceSymbol.COMPASS), List.of(ManufacturedGood.TEXTILE)));
        allCards.add(new ScienceCard(1, "Aphoteke", 5, List.of(ScienceSymbol.COMPASS), List.of(ManufacturedGood.TEXTILE)));
        allCards.add(new ScienceCard(1, "Werkstat", 3, List.of(ScienceSymbol.COGWHEEL), List.of(ManufacturedGood.GLASS)));
        allCards.add(new ScienceCard(1, "Skriptorium", 3, List.of(ScienceSymbol.TABLET), List.of(ManufacturedGood.SCRIPTS)));
        allCards.add(new ScienceCard(1, "Skriptorium", 4, List.of(ScienceSymbol.TABLET), List.of(ManufacturedGood.SCRIPTS)));
    }

    private void addAge2() {
        // RESOURCES
        allCards.add(new SingleManufacturedGoodCard(2, "Glashutte", ManufacturedGood.GLASS, 4));
        allCards.add(new SingleManufacturedGoodCard(2, "Glashutte", ManufacturedGood.GLASS, 3));
        allCards.add(new SingleManufacturedGoodCard(2, "Presse", ManufacturedGood.SCRIPTS, 5));
        allCards.add(new SingleManufacturedGoodCard(2, "Presse", ManufacturedGood.SCRIPTS, 3));
        allCards.add(new SingleManufacturedGoodCard(2, "Webstuhl", ManufacturedGood.TEXTILE, 5));
        allCards.add(new SingleManufacturedGoodCard(2, "Webstuhl", ManufacturedGood.TEXTILE, 3));
        ...
        allCards.add(new CivilCard(2, "Gericht", 4, 5, new AggregateCost(
                List.of(
                        ...
                        new ManufacturedGoodCost(List.of(ManufacturedGood.TEXTILE))
                )
        )));
        ...
        allCards.add(new CivilCard(2, "Tempel", 3, 3, new AggregateCost(
                List.of(
                        ...
                        new ManufacturedGoodCost(List.of(ManufacturedGood.GLASS))
                )
        )));
        ...
        allCards.add(new ScienceCard(2, "Schule", 3, List.of(ScienceSymbol.TABLET), new AggregateCost(
                List.of(
                        ...
                        new ManufacturedGoodCost(List.of(ManufacturedGood.SCRIPTS))
                )
        )));
